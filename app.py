...
@app.route('/search')
def search():
    d = {"Hypocalcemia": ["asymptomatic", "jitteriness", "irritability", "seizure", "lethargy", "poor feeding", "vomiting", "ileus"], "Hypercalcemia": ["asymptomatic", "poor feeding", "vomiting", "constipation", "diarrhea", "seizure", "bradycardia", "hypertension", "failure to thrive (ftt)", "nephrocalcinosis"], "Hypomagnesemia": ["the same as hypocalcemia (asymptomatic", "jitteriness", "irritability", "seizure", "lethargy", "poor feeding", "vomiting", "ileus", "persistent hypocalcemia"], "hypermagnesemia": ["hypotonia", "paralysis", "cns depression", "hypotension", "vomiting"], "hypernatremia": ["asymptomatic", "dehydrated", "ftt", "irritability", "lethargy", "hyperpnea", "thirst", "fever", "brain hemorrhage (if untreated)"], "hyponatremia": ["vomiting", "lethargy", "seizure"], "hyperkalemia": ["fasciculations", "paralysis", "conductive heart disorders"], "hypokalemia": ["muscle weakness", "paralysis", "rhabdomyolysis", "constipation", "ileus", "urinary retention", "polyuria", "conductive heart disorders"], "hyperphosphatemia": ["systemic calcification", "hypocalcemia (jitteriness", "irritability", "seizure", "lethargy", "poor feeding", "vomiting", "ileus"], "hypophosphatemia": ["proximal muscle weakness", "acute respiratory failure", "seizures", "coma", "rhabdomyolysis", "rickets"], "Hypothyroidism": ["wide fontanels", "prolonged jaundice", "lethargy", "preorbit edema", "hypotonia", "weak cry", "constipation", "large tongue", "abdominal distension", "umbilical hernia", "bradycardia", "hypokinesia hypotension", "anemia", "feeding problems", "dry skin"], "Hyperthyroidism": ["prematurity", "hyperkinesia", "diarrhea", "poor weight gain", "hepatosplenomegaly", "jaundice", "craniosynostosis", "tachycardia", "exophthalmia", "goiter"], "Hyperparathyroidism": ["hypercalcemia", "hypotonia", "constipation", "respiratory distress"], "Hypoparathyroidism": ["hypocalcemia", "hyperphosphatemia", "low serum pth"], "CAH (Congenital Adrenal Hyperplasia)": ["hypoglycemia:"], " Hypoglycemia": ["asymptomatic", "cyanosis", "apnea", "hypothermia", "hypotonia", "poor feeding", "lethargy", "seizures"], "21 hydroxylase deficiency": ["glucocorticoid deficiency", "mineralocorticoid deficiency ( salt wasting crisis)", "postnatal virilization in male and female", "ambigus genitalia in female"], "3B Hydroxysteroid dehydrogenase deficiency": ["glucocorticoid deficiency", "mineralocorticoid deficiency (salt wasting crisis)", "ambigus genitalia in male and female"], "congenital lipoid adrenal hyperplasia(STAR)": ["glucocorticoid deficiency", "mineralocorticoid deficiency (salt wasting crisis)", "ambigus genitalia in male", "poor pubertal development", "premature ovarian failure"], "11B-Hydroxylase deficiency": ["glucocorticoid deficiency", "ambigus genitalia in female", "postnatal virilization in male and female", "hypertension"], "17a-Hydroxylase deficiency": ["cortisol deficiency", "ambigus genitalia in male", "hypertension"], "Hypoglycemia": ["lethargy", "tremors", "seizure", "hyporeflexia"], "IVH (Intra Ventricular Hemorrhage)": ["asymptomatic", "hypotension", "apnea", "pallor", "lethargy", "seizure", "hypotonia"], "HIE (Hypoxic Ischemic Encephalopathy)": ["pallor", "cyanosis", "apnea", "bradycardia", "unresponsiveness", "hypotonia", "hypertonia", "seizure", "decortication", "decerebrated", "hyperactivity", "myoclonus"], "Erb-Duchenne paralysis": ["adduction and internal rotation of the arm", "forearm pronation", "limitation in arm abduction", "limitation in external rotation of the arm", "limitation in forearm supination", "absent of biceps reflex", "absent of moro reflex in affected side", "presence of grasp reflex"], "Klumpke paralysis": ["hand paralysis in affected side", "ipsilateral ptosis and miosis"], "Phrenic nerve paralysis": ["irregular and labored respirations", "diminished breath sounds", "absence of abdomen balging during inspiration"], "RDS (respiratory distress syndrome)": ["tachypnea", "grunting", "cyanosis", "respiratory distress"], "BPD (BrunchoPulmonary Dysplasia)": ["persistent respiratory distress", "persistent cyanosis"], "TTN (Transient Tachypnea of the Neonate)": ["early tachypnea after birth", "grunting", "respiratory distress", "cyanosis", "recovery in 12 to 24 hours"], "MAS (Meconium Aspiration Syndrome)": ["tachypnea", "grunting", "cyanosis", "respiratory distress"], "CDH (Congenital Diaphragmatic Hernia)": ["asymptomatic", "respiratory distress", "scaphoid abdomen", "prominent chest", "cyanosis", "reduce lung sounds"], "Pneumothorax": ["reduce lung sounds", "sudden cyanosis", "respiratory distress", "distant abdomen", "bradycardia"], "Lung hemorrhage": ["tachypnea", "grunting", "cyanosis", "respiratory distress", "pallor", "bloody discharge from trachea"], "PPHN (Persistent Pulmonary Hypertension of the Newborn) ": ["early severe cyanosis", "poor response to oxygen therapy respiratory distress", "organ involvement"], "Meconium plug": ["abdomen distension", "multiple dilated bowel loops", "passage of the meconium following rectal examination"], "Ileus meconium": ["early abdomen distension", "persistent biliary vomiting", "failure to deficate", "bowel perforation", "multiple dilated bowel loops"], " Meconium peritonitis": ["abdomen distension", "persistent biliary vomiting", "bowel perforation", "tense abdomen", "generally ill"], "NEC (Necrotizing Enterocolitis)": ["present after first week of life", "temperature instability", "abdomen distension", "feeding intolerance", "bloody stool", "vomiting", "abdominal wall erythema", "apnea", "lethargy", "respiratory failure", "bowel perforation"], "Kernicterus": ["hypotonia", "hypertonia", "stupor", "seizure", "fever", "hearing loss", "movement disorder", "icterus"], "Hirschprung": ["distended abdomen", "vomiting", "fail to pass meconium", "explosive stool after rectal examination", "chronic constipation", "failure to thrive"], "Duodenal atresia": ["bilious vomiting", "undistented abdomen", "noted on the first day of life"], "Distal intestinal atresia": ["bilious vomiting", "distended abdomen", "noted rapidly after initiation of feeding", "fail to pass meconium"], "Omphalocele": ["soft swelling covered by peritoneum", "located to the umbilical site", "unrelated to straining"], "Gastroschisis": ["exposed abdominal contents", "no covering", "located to the right of the umbilical site"], "RH incompatibility (hemolytic disease of the fetus and newborn)": ["pallor", "heart failure", "hydrops", "icterus in first 24 hour of life"], "ABO incompatibility": ["icterus in first 24 hour of life", "pallor"], "Polycythemia": ["asymptomatic", "plethora", "irritability", "lethargy", "tachypnea", "cyanosis", "respiratory distress", "poor feeding", "icterus", "hypoglycemia", "seizure", "thrombosis"], " Early vitamin k deficiency": ["present in the first 24 hours of life", "scalp bleeding", "subperiosteal bleeding", "cutaneous bleeding", "intracranial bleeding", "intrathoracic bleeding", "gastrointestinal bleeding"], "Classic vitamin k deficiency": ["present in days 1-7 of life", "gastrointestinal bleeding", "umblical bleeding", "cutaneous bleeding", "nose bleeding", "post circumcision bleeding"], "Late vitamin k deficiency": ["present after 8 days of life", "intracranial bleeding", "cutaneous bleeding", "gastrointestinal bleeding"], "Hydrops": ["ascites", "pleural effusion", "pericardial effusion", "cutaneous edema", "heart failure", "polyhydramnios"], "Umbilical granuloma": ["small and soft vascular lesion", "dull red or pink color", "mucoid discharge"], "Umbilical polyp": ["firm lesion", "bright red", "mucoid discharge"], "Umbilical hernia": ["soft swelling", "covered by skin", "protrudes during straining"], "Omphalitis": ["purulent smelly discharge of the umbilical stump", "surrounding erythema", "induration", "tenderness"], "Sepsis": ["temperature instability", "poor feeding", "lethargy", "edema", "abdominal distension", "vomiting", "apnea", "respiratory distress", "cyanosis", "mottling", "tachycardia", "bradycardia", "seizure", "hypotonia", "high pitched cry", "icterus", "bleeding"], "Toxoplasma gondii": ["hepatosplenomegaly", "jaundice", "pneumonitis", "petechiae or\u00a0purpura", "meningoencephalitis", "hydrocephalus", "microcephaly", "maculopapular exanthems", "intracranial calcifications", "myocarditis", "bone lesions", "chorioretinitis or retinopathy", "cataracts", "optic atrophy", "microphthalmia", "uveitis"], "\u00a0Rubella Virus": ["hepatosplenomegaly", "jaundice", "pneumonitis", "petechiae or\u00a0purpura", "meningoencephalitis", "hydrocephalus", "adenopathy", "hearing deficits", "myocarditis", "congenital defects", "\u00a0bone lesions", "glaucoma", "chorioretinitis or retinopathy", "cataracts", "microphthalmia"], "\u00a0\u00a0Cytomegalovirus": ["hepatosplenomegaly", "jaundice", "pneumonitis", "petechiae or\u00a0purpura", "meningoencephalitis", "hydrocephalus microcephaly", "intracranial", "calcifications", "\u00a0hearing deficits", "chorioretinitis or retinopathy", "optic atrophy"], "\u00a0Herpes Simplex Virus": ["\u00a0hepatosplenomegaly", "jaundice", "pneumonitis", "petechiae or purpura", "meningoencephalitis", "hydrocephalus microcephaly", "maculopapular", "exanthems", "vesicles", "\u00a0myocarditis", "chorioretinitis or\u00a0retinopathy", "cataracts"], "TGA (Transposition of Great arteries)": ["present in the first week of life", "severe cyanosis", "tachypnea without respiratory distress", "prominent second heart sound", "normal peripheral pulses"], "TOF (Tetralogy of Fallot)": ["systolic ejection murmur along the left sternal border", "single second heart sound", "cyanosis associated with pulmonary stenosis degree"], "Tricuspid Atresia": ["cyanosis at birth", "normal pericardial activity", "single first heart sound", "systolic ejection murmur", "tachypnea", "third heart sound", "hepatomegaly"], "Pulmonary Atresia": ["early severe cyanosis", "unstable hemodynamic", "tachypnea", "tachycardia", "hepatomegaly", "shock"], "Ebstein Anomaly": ["severe cyanosis", "tachypnea", "shock", "holosystolic murmur", "multiple systolic clicks", "first heart sound splitting", "cardiomegaly"], "TAPVR (Total Anomalous|Pulmonary Venous Return)": ["asymptomatic", "recurrent pneumonias", "cyanosis", "respiratory distress"], "Truncus Arteriosus": ["cyanosis", "tachypnea", "bounding pulses"], "HLHS (Hypoplastic Left Heart Syndrome)": ["cyanosis", "tachypnea", "single second heart sound", "shock"], "Aortic Stenosis": ["systolic ejection murmur radiating to the neck", "shock", "multiorgan failure following ductal", "closure"], "Aortic coarctation": ["asymptomatic", "diminished femoral pulses", "tachypnea", "tachycardia", "poor feeding", "lethargy", "shock", "multiorgan failure following ductal closure", "oxygen saturation differentials between the upper and lower extremities"], "VSD (Ventricular Septal Defects)": ["asymptomatic", "late presentation", "holosystolic murmur along the left sternal border", "normal saturation"], "ASD (Atrial Septal Defect)": ["asymptomatic", "wide and fixed second hear sound splitting"], "AVSD (Atrioventricular Septal defect)": ["holosystolic murmur at the apex", "tachypnea", "normal saturation"], "PDA (Patent Ductus Arteriosus)": ["asymptomatic", "hyper dynamic precordium", "bounding pulses", "machinery heart murmur", "tachycardia", "cardiomegaly", "hepatomegaly", "renal failure"], "Neonatal Abstinence Syndrome (NAS)": ["tremor", "poor feeding", "high pitched cry", "lack of sleeping", "irritability", "hyperactive reflexes", "sneezing", "frequent yawning", "hiccup", "myoclonic jerk", "vomiting", "watery stool", "seizure", "increased muscle tone", "excoriation", "sweating", "fever", "nasal stuffiness", "tachypnea"], "Metabolic Disorders": ["presenting after first week of life", "lethargy", "poor feeding", "hypoglycemia", "vomiting", "episthotonus", "hypotonia", "acidosis"]}
    df=pd.DataFrame.from_dict(d,orient='index').fillna(0)
    if "disease" in request.agrs:
        try:
            list=request.args.get('disease')
            mylist = [str(list)]
            pattern = '|'.join(mylist)
            symptoms=df.filter(like='Neonata', axis=0)
            return jsonify({'status' :"200","statusMessage":"SUCCESS","message":"Get Assigning API Running","data":symptoms.values.tolist()[0]}) 
        except:
            return jsonify("No data found")
    if "symptoms" in request.agrs:
        try:
            list=request.args.get('symptoms')
            mylist = [str(list)]
            pattern = '|'.join(mylist)
            disease=df.index[df.apply(lambda row: row.astype(str).str.contains(pattern).any(), axis=1)].tolist()
            return jsonify({'status' :"200","statusMessage":"SUCCESS","message":"Get Assigning API Running","data":disease})  
        except:
            return jsonify("No data found")
    else:
        return jsonify("No data found")
