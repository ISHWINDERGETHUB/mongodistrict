    ...
    if "disease" in request.args:
        try:
            ...
            try:
                ...
                pass
            return jsonify({'status' :"200","statusMessage":"SUCCESS","message":"Get Symptoms API Running","data":symptoms}) 
        except:
            return jsonify("No data found")
    if "symptoms" in request.args:
        try:
