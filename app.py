...
d = {
   ...
   "Cah-21 Hydroxylase Deficiency": [
       ...
       "Postnatal Virilization In Male And Female",
   ...
   "Cah-3b Hydroxysteroid Dehydrogenase Deficiency": [
       ...
       "Glucocorticoid Deficiency",
       "Mineralocorticoid Deficiency (Salt Wasting Crisis)",
       "Ambigus Genitalia In Male And Female"
   ],

   "Cah-congenital Lipoid Adrenal Hyperplasia(Star)": [
       "Hypoglycemia ",
       "Asymptomatic",
       "Cyanosis",
       "Apnea",
   ...
   "Erb-duchenne Paralysis":[
      ...
      "Forearm Pronation",
      "Limitation In Arm Abduction",
      "Limitation In External Rotation Of The Arm",
      "Limitation In Forearm Supination",
      "Absent Of Biceps Reflex",
      "Absent Of Moro Reflex In Affected Side",
      "Presence Of Grasp Reflex"
   ],
   "Klumpke Paralysis":[
      "Hand Paralysis In Affected Side",
   ...
   "Meconium Plug":[
      ...
      "Passage Of The Meconium Following Rectal Examination"
   ],
   "Ileus Meconium":[
      "Early Abdomen Distension",
      "Persistent Biliary Vomiting",
      "Failure To Deficate",
      "Bowel Perforation",
      "Multiple Dilated Bowel Loops"
   ],
   ...
   "Duodenal Atresia":[
      "Bilious Vomiting",
      "Undistented Abdomen",
      "Noted On The First Day Of Life"
   ],
   "Distal Intestinal Atresia":[
      "Bilious Vomiting",
      "Distended Abdomen",
      "Noted Rapidly After Initiation Of Feeding",
      "Fail To Pass Meconium"
   ],
   "Omphalocele":[
      "Soft Swelling Covered By Peritoneum",
      "Located To The Umbilical Site",
      "Unrelated To Straining"
   ],
   "Gastroschisis":[
   ...
   "Rh Incompatibility (Hemolytic Disease Of The Fetus And Newborn)":[
      ...
      "Heart Failure",
      "Hydrops",
      "Icterus In First 24 Hour Of Life"
   ],
   "Abo Incompatibility":[
      "Icterus In First 24 Hour Of Life",
      "Pallor"
   ...
   "Umbilical Granuloma":[
      "Small And Soft Vascular Lesion",
      "Dull Red Or Pink Color",
      "Mucoid Discharge"
   ],
   "Umbilical Polyp":[
      "Firm Lesion",
   ...
   "Omphalitis":[
      "Purulent Smelly Discharge Of The Umbilical Stump",
   ...
   "Aortic Stenosis":[
      ...
      "Shock",
      "Multiorgan Failure Following Ductal",
      "Closure"
   ],
   "Aortic Coarctation":[
      "Asymptomatic",
   ...
   "Metabolic Disorders":[
      "Presenting After First Week Of Life",
      "Lethargy",
      "Poor Feeding",
      "Hypoglycemia",
      "Vomiting",
...
def search2():
    ...
    if "Disease" in request.form.to_dict():
        try:  
            data=request.form.to_dict()
            mylist=data["Disease"].capitalize() 
            data=df.filter(like=mylist, axis=0)
            symptoms=data.values.tolist()[0]
            val = 0
            try:
